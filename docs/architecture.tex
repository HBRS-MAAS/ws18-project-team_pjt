...
\newcommand{\REFERENT}[0]{Prof. Dr. Gerhard Kraetzschmar, Argentina Ortega}
\newcommand{\TITLE}[0]{Multi Agent and Agent Systems}
\newcommand{\TYPE}[0]{Semesterproject report }
...
%\newpage
\input{AgentObjectDescribtion.tex}
%\newpage
%\input{DesignDecisions.tex}
